...
class CNNModel():
    ...
    def create_model(self,x_images):
        #first layer
        ...
        h_conv2 = tf.nn.relu(tf.nn.bias_add(self.conv2d(h_pool1, w_conv2), b_conv2))
        ...
        h_conv3 = tf.nn.relu(tf.nn.bias_add(self.conv2d(h_pool2, w_conv3), b_conv3))
        ...
        h_dropout3_flat = tf.reshape(h_pool3, [-1, 64 * conv_width * conv_height])
